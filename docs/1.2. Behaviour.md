...
When a Sender is in this violated state, responding with a `204 No Content`, This state indicated a Sender is unbound by a Media Profile and is similar to the initial state.
